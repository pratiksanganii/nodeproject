...
Follow.prototype.validate = async function(action){
    ...
    if(action=="create"){if(doesFollowAlreadyExist){this.errors.push("You are already this user.")}}
    if(action=="delete"){if(!doesFollowAlreadyExist){this.errors.push("You cannot stop following someone you do not already follow.")}}
